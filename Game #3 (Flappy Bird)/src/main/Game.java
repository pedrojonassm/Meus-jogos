...
public class Game extends Canvas implements Runnable, KeyListener, MouseListener, MouseMotionListener {
	...
	public static final int WIDTH = 640, HEIGHT = 320, SCALE = 2, TS = 16;
	...
	public Game() {
		...
		player = new Player(0, 0, Game.TS, Game.TS, 2, Game.spritesheet.getSprite(2 * Game.TS, 0, Game.TS, Game.TS));
	...
	public void render() {
		...
		g.setColor(new Color(93, 127, 121));
