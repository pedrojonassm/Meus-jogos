...
public class Menu {
	...
	public String[] options = {"Novo Jogo", "Controles", "Ver Ranks", "Sair"};
	...
	public void render(Graphics g) {
		...
		w = g.getFontMetrics().stringWidth("Silêncio Espacial");
		g.drawString("Silêncio Espacial", Game.WIDTH/2-w/2, Game.HEIGHT/2-30);
		g.setFont(new Font("Arial", Font.BOLD, 12));
